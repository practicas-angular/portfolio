...
export const PROJECTS_DATA: Project[] = [
  ...
  },
  {
    ...
    title: 'Vesto',
    description:
      'Proyecto desarrollado junto a 4 compañeros. App web para creación de conjuntos de ropa.',
  ...
  },
  {
    ...
    description:
      'Landing del IES Albarregas utilizando componentes shacdn y un diseño 3D desarrollado en Blender.',
  ...
  },
  {
    ...
    title: 'ExtremaDev',
    description:
      'Landing de web de programadores extremeños utilizando animaciones GSAP.',
  ...
  },
  {
    ...
    githubUrl:
      'https://github.com/jgmuriels01/front-projects/tree/main/tablero-kanban',
  ...
  },
  {
    ...
    description:
      'Mini juego en js con gestión de escenas en single page con mercado interactivo.',
    img: '/assets/img/projects/aventura-reino-js.jpg',
    githubUrl:
      'https://github.com/jgmuriels01/front-projects/tree/main/aventura-reino-js',
    deployUrl:
      'https://jgmuriels01.github.io/front-projects/aventura-reino-js/',
  },
  {
    id: 7,
    title: 'Panel de usuario',
    description:
      'Introducción a formularios js con almacenamiento de información en cookies.',
    img: '/assets/img/projects/panel-usuario.jpg', // Used to test your fallback image functionality
    githubUrl:
      'https://github.com/jgmuriels01/front-projects/tree/main/panel-usuario',
...

  {
    ...
    description:
      'Buscador de gasolineras por provinvia, municipio, tipo de combustible y horas de apertura comprobando fecha actual.',
    img: '/assets/img/projects/gasolineras.jpg', // Used to test your fallback image functionality
    githubUrl:
      'https://github.com/jgmuriels01/front-projects/tree/main/gasolineras',
...

  {
    ...
    githubUrl: '#',
    deployUrl:
      'https://www.figma.com/design/tKqqDKgI7jMtW1YAyvf3OP/Portfolio?m=auto&t=bINoRaJ4uhXkKBfU-6',
  },
  {
    id: 10,
    title: 'Gestión de fechas',
    description:
      'Contador de tiempo hasta fecha indicada, remarcando tiempo restante mediante un sistema de colores.',
    img: '/assets/img/projects/gestion-fechas.jpg', // Used to test your fallback image functionality
    githubUrl:
      'https://github.com/jgmuriels01/front-projects/tree/main/gestion-fechas',
...
export const JOB_EXPERIENCE: Experience[] = [
  {
    ...
    description:
      'Gestión de proyectos y soporte técnico a nivel internacional, resolviendo problemas complejos en tiempo real para clientes en toda Europa. Desarrollé fuertes habilidades de comunicación transversal y adaptación en entornos multiculturales.',
  },
  {
    ...
    description:
      'Gestión de proyectos y diseño técnico. Soporte de ventas y supervisión de fabicación y ensamblaje.',
  },
  {
    ...
    description:
      'Aplicación de análisis de datos y modelado estadístico para optimizar procesos de I+D. Implementación de Diseño de Experimentos (DOE) y Control de Calidad Interno (IQC), demostrando un enfoque altamente analítico y metódico.',
  },
];
